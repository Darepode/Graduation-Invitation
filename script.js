document.addEventListener('DOMContentLoaded', function() {
    ...
    const noBtnResponses = [
        ...
        "How about now?", "Changed your mind yet?", "Hey friend, I know you would say yes!", "Say yes already!"
    ];
    ...
    if (chooseLocationBtn) {
        chooseLocationBtn.addEventListener('click', function() {
            // Thay URL dưới đây bằng link bạn mong muốn
            const targetUrl = 'https://chamleegrad.my.canva.site/invi'; 
            // Mở cùng tab:
            window.location.href = targetUrl;
            // Nếu muốn mở tab mới, dùng:
